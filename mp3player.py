...
root = Tk()
root.title("Basic MP3 Player")
root.iconbitmap("G:/My Projects/mp3player/gui/favicon.ico")
...
def play_time():
	...
	song = f'G:/My Projects/mp3player/audio/{song}.mp3'
...
#Add Song Function
def add_song():
	song = filedialog.askopenfilename(initialdir='G:/My Projects/mp3player/audio/', title="Choose A Song", filetypes=(("mp3 Files", "*.mp3"), ))
	
	#strip out the directory info and .mp3 extension from the song name
	song = song.replace("G:/My Projects/mp3player/audio/", "")
...
def add_many_songs():
	songs = filedialog.askopenfilenames(initialdir='G:/My Projects/mp3player/audio/', title="Choose A Song", filetypes=(("mp3 Files", "*.mp3"), ))	
...
back_btn_img = PhotoImage(file='G:/My Projects/mp3player/gui/back.png')
forward_btn_img =  PhotoImage(file='G:/My Projects/mp3player/gui/forward.png')
play_btn_img =  PhotoImage(file='G:/My Projects/mp3player/gui/play.png')
pause_btn_img =  PhotoImage(file='G:/My Projects/mp3player/gui/pause.png')
stop_btn_img =  PhotoImage(file='G:/My Projects/mp3player/gui/stop.png')
...
global vol3
global vol4
vol0 = PhotoImage(file='G:/My Projects/mp3player/gui/volume0.png')
vol1 = PhotoImage(file='G:/My Projects/mp3player/gui/volume1.png')
vol2 = PhotoImage(file='G:/My Projects/mp3player/gui/volume2.png')
vol3 = PhotoImage(file='G:/My Projects/mp3player/gui/volume3.png')
vol4 = PhotoImage(file='G:/My Projects/mp3player/gui/volume4.png')
